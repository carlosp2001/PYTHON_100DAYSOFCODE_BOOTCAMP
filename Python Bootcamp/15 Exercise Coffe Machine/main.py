...
def update_resource(usercooffechoice):
    global resources
    for ingredient in MENU[usercooffechoice]['ingredients']:
        resources[ingredient] -= MENU[usercooffechoice]['ingredients'][ingredient]
...
def process_coins():
    ...
    total = (quarters*coins['quarters'])+(dimes*coins['dimes'])+(nickles*coins['dimes'])+(pennies*coins['pennies'])
