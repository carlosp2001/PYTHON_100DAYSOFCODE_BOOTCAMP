...
first_choice=input("You're at crossroad. Where do you want to go? Typer 'left' or 'rigth' ").lower()
if first_choice=="left":
  second_choice=input("You\'ve come to a lake. There is an island in the middle of the lake."+
  " Type 'wait' to wait for a boat. Type 'swim' to swim across. ").lower()
  if second_choice=="wait":
    third_choice=input('You arrive at the island unharmed. There is a house with 3 doors. One red,'+
